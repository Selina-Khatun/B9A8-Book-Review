    ...
    <section>
      <article className="max-w-5xl px-6 py-24 mx-auto space-y-12  text-gray-900">
        <div className="w-full mx-auto space-y-4 text-center">
          ...
          <h1 className="text-3xl font-bold leading-10 md:text-5xl">We’ve  included the advantages of every book review site for readers and authors.</h1>
          <p className="text-sm text-gray-400">by <span> </span>
            <a rel="noopener noreferrer" href="#" target="_blank" className="underline text-violet-400">
              <span itemProp="name"> Book Vibe </span>
            </a> {' '} on
        ...
        <div className="pt-12 border-t border-gray-700">
          <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400">Stay tuned as we reveal the top book review sites for 2024!  Whether you’re in the mood for a classic drama, a modern thriller, or an enlightening non-fiction, there’s a review site that can point you in the right direction.
