            ...
            <section className="text-gray-700 body-font overflow-hidden bg-white">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <img alt="" className="lg:w-1/2 w-full object-contain bg-[#1313130D] object-center rounded border border-gray-200" src={card.image} />
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="border-y-2 my-5 py-2">Fiction</p>
                            ...
                            <div className="flex text-center items-center my-4  gap-3">
                                ...
                                <h1 className="bg-[#23BE0A0D] text-[#23BE0A] py-1 px-7 rounded-full font-semibold text-xl ">#{card.tags[0]}</h1>
                                <h1 className="bg-[#23BE0A0D] text-[#23BE0A] py-1 px-7 rounded-full font-semibold text-xl ">#{card.tags[1]}</h1>
                            </div>
